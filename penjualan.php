...
<body>
  <header><h1>PENJUALAN</h1></header>
    ...
    <center>   
        ...
        <h3>PENJUALAN</h3><br><tr>
    <a>Nama Barang </a><select name="nb" required>
    <?php 
      include 'koneksi.php';
      ...
      <br><br>
      <a>Harga Jual</a>
      <input name="jumlah" type="number"><br><br>
      <button>Submit</button><br><br><br></center>
    <table border="1">
    <tr><th>NO</th><th>Nama Barang</th><th>Harga Jual</th><th>Stok</th></tr>
    <?php 
      include 'koneksi.php';
